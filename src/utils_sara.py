...
def find_similar_advice_with_cossim(query_text, advice_type='proactive', top_k=1, advice_kb=None):
    """
    Find the most similar advice based on the query text.
    ...
    return [records[i] for i in top_k_indices], [similarities[i][1] for i in range(top_k)]
